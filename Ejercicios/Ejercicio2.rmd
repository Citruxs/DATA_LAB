...
```{r}
fviz_cluster(modelo_k, data = proyecciones)
```
...
```{r}
ggplot() + geom_density(mapping = aes(x = proyecciones$RC1), fill = "blue", alpha = 0.5) + geom_vline(mapping = aes(xintercept = medias$RC1, colour = as.factor(medias$`modelo_k$cluster`))) + labs(title = "Densidad de la componente `Calidad del servicio`", color = c("Clúster")) + theme_minimal()

ggplot() + geom_density(mapping = aes(x = proyecciones$RC2), fill = "blue", alpha = 0.5) + geom_vline(mapping = aes(xintercept = medias$RC2, colour = as.factor(medias$`modelo_k$cluster`))) + labs(title = "Densidad de la componente `Crecimiento del negocio`", color = c("Clúster")) + theme_minimal()

ggplot() + geom_density(mapping = aes(x = proyecciones$RC3), fill = "blue", alpha = 0.5) + geom_vline(mapping = aes(xintercept = medias$RC3, colour = as.factor(medias$`modelo_k$cluster`))) + labs(title = "Densidad de la componente `Demografía`", color = c("Clúster")) + theme_minimal()
```
